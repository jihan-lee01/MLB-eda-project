...
payrollRoster18 <- filterPayrollRoster(payrollRoster18)
payrollRoster19 <- filterPayrollRoster(payrollRoster19)
payrollRoster21 <- filterPayrollRoster(payrollRoster21)
payrollRoster22 <- filterPayrollRoster(payrollRoster22)
payrollRoster23 <- filterPayrollRoster(payrollRoster23)
```
...
```{r merge datasets}
payrollRoster18$RANK <- as.integer(payrollRoster18$RANK)
payrollRoster19$RANK <- as.integer(payrollRoster19$RANK)
payrollRoster21$RANK <- as.integer(payrollRoster21$RANK)
payrollRoster22$RANK <- as.integer(payrollRoster22$RANK)
payrollRoster23$RANK <- as.integer(payrollRoster23$RANK)

payrollData18 <- full_join(payrollPosition18, payrollRoster18, by = c('TEAM', 'RANK', 'ROSTER'))
payrollData19 <- full_join(payrollPosition19, payrollRoster19, by = c('TEAM', 'RANK', 'ROSTER'))
payrollData21 <- full_join(payrollPosition21, payrollRoster21, by = c('TEAM', 'RANK', 'ROSTER'))
payrollData22 <- full_join(payrollPosition22, payrollRoster22, by = c('TEAM', 'RANK', 'ROSTER'))
payrollData23 <- full_join(payrollPosition23, payrollRoster23, by = c('TEAM', 'RANK', 'ROSTER'))
